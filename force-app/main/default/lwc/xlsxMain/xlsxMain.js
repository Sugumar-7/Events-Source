...
export default class XlsxMain extends LightningElement {
  ...
  @api download() {
    ...
    /* form data key list */
      ...
      // var ss = ['EVENT', 'test'];
      // createXLSLFormatObj[0].unshift(ss);
      // createXLSLFormatObj[0].unshift([]);
      // console.log("XlsxMain -> @apidownload -> createXLSLFormatObj", JSON.stringify(createXLSLFormatObj));
    /* creating new Excel */
    ...
    const downloadComplete = new CustomEvent('xlsxdownloadcomplete', { detail: true });
